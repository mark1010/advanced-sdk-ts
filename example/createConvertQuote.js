...
const convertService = new ConvertsService(client);

// Pass as an argument such as node example/createConvertQuote.js USDC USD 5
// or can convert EURC and EUR
const fromAccount = process.argv[2];
const toAccount = process.argv[3];
const amount = process.argv[4];

convertService
  .createConvertQuote({ fromAccount, toAccount, amount })
  .then((pm) => {

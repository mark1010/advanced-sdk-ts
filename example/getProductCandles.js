...
// Pass as an argument such as node example/getProductCandles.js BTC-USD 1738046500 1738048600 ONE_MINUTE
...
productService
  .getProductCandles({ productId, start, end, granularity })
  .then((pc) => {

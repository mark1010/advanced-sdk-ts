...
// Pass as an argument such as node example/movePortfolioFunds.js <srcPortfolioId> <targetPortfolioId> <currency> <value>
const sourcePortfolioUuid = process.argv[2];
const targetPortfolioUuid = process.argv[3];

...
const prodService = new ProductsService(client);

// Pass as an argument such as node example/getProductBestBidAsk.js <productIds>
...
prodService
  ...
  .then((pm) => {
    ...
    console.log('Total Products: ' + pm.pricebooks.length);
  })
